...
function M._setup_buffer(name, buf, tab)
    ...
    vim.api.nvim_buf_set_keymap(buf, "n", "s", ":LTJumpSplitCalltree<CR>", opts)
    vim.api.nvim_buf_set_keymap(buf, "n", "v", ":LTJumpVSplitCalltree<CR>", opts)
    vim.api.nvim_buf_set_keymap(buf, "n", "t", ":LTJumpTabCalltree<CR>", opts)
