...
function M._setup_buffer(name, buf, tab)
    ...
    vim.api.nvim_buf_set_keymap(buf, "n", "s", ":LTJumpSplitSymboltree<CR>", opts)
    vim.api.nvim_buf_set_keymap(buf, "n", "v", ":LTJumpVSplitSymboltree<CR>", opts)
    vim.api.nvim_buf_set_keymap(buf, "n", "t", ":LTJumpTabSymboltree<CR>", opts)
