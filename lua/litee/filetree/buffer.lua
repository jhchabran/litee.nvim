...
function M._setup_buffer(name, buf, tab)
    ...
    vim.api.nvim_buf_set_keymap(buf, "n", "s", ":LTJumpSplitFiletree<CR>", opts)
    vim.api.nvim_buf_set_keymap(buf, "n", "v", ":LTJumpVSplitFiletree<CR>", opts)
    vim.api.nvim_buf_set_keymap(buf, "n", "t", ":LTJumpTabFiletree<CR>", opts)
